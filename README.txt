...
Thank you for checking out our project! Please read the following:

	To play, unzip the folder somewhere on your desktop. From there, you can run the index.html file!
	
	A Sense of Nowhere relies on browser autoplay to function. To enable this on Firefox, do either of the following:
